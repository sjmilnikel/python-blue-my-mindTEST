...
def main():
    translate_text('I am learning to enjoy coding in AWS','fr','en') # we provide the value for the arguments when we call the function in the correct positional order.
